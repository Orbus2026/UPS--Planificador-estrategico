...
export default function NeuralBackground({
  ...
  particleCount = 600,
  speed = 1,
  backgroundColor = "rgba(0, 0, 0, 0.15)" // Added prop for background clearing color
}) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Using a slightly more opaque black for better trail clearing if not provided
      ctx.fillStyle = backgroundColor || `rgba(0, 0, 0, ${trailOpacity})`; 
      
      // If we want transparency we might use clearRect, but trails require overdrawing.
      // For this specific effect, we fill with the background color to fade previous frames.
      // We assume the background is solid for the trails to work best.
